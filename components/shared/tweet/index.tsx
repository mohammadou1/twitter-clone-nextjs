...
const TweetComponent: React.FC<ITweet> = props => {
    return <div className="flex cursor-pointer hover:bg-dark-lighter p-3 anim border-b border-gray-100 border-opacity-15">
        <Link href="/mhmdou1">
        ...
        <div className="flex-grow px-3 pb-1 relative">
            ...
            <div className="pr-1">
                <span className="text-white" dangerouslySetInnerHTML={{ __html: props.description || '' }}>
                </span>
            ...
            <div className="flex mt-3">
                <div className="text-gray-500 hover:text-primary anim flex items-center flex-grow">
                    <Replies height="1.2rem" />
                    <span className="ml-3 text-xs">
                        {props.replies}
                    </span>
                </div>
                <div className="text-gray-500 hover:text-green-600 anim flex items-center flex-grow">
                    <Retweet height="1.2rem" />
                    <span className="ml-3 text-xs">
                        {props.retweets}
                    </span>
                </div>
                <div className="text-gray-500 hover:text-pinkish anim flex items-center flex-grow">
                    <Heart height="1.2rem" />
                    <span className="ml-3 text-xs">
                        {props.likes}
                    </span>
